...
FRONTEND_ONBOARDING_PATH = config("FRONTEND_ONBOARDING_PATH", default="/onboarding")
FRONTEND_ONBOARDING_PROFILE_PATH = config("FRONTEND_ONBOARDING_PROFILE_PATH", default="/onboarding/profile")
FRONTEND_ONBOARDING_COMPANY_PATH = config("FRONTEND_ONBOARDING_COMPANY_PATH", default="/onboarding/company")
FRONTEND_ONBOARDING_REVIEW_PATH = config("FRONTEND_ONBOARDING_REVIEW_PATH", default="/onboarding/review")
FRONTEND_ONBOARDING_ACTIVATION_PATH = config("FRONTEND_ONBOARDING_ACTIVATION_PATH", default="/onboarding/activation")
FRONTEND_WELCOME_PATH = config("FRONTEND_WELCOME_PATH", default="/welcome")
WORKSPACE_ACTIVATION_TOKEN_DAYS = config("WORKSPACE_ACTIVATION_TOKEN_DAYS", default=7, cast=int)
WORKSPACE_ACTIVATION_LINK_VIA_API = config("WORKSPACE_ACTIVATION_LINK_VIA_API", default=True, cast=bool)
